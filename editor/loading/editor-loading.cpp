...
void EditorLoading::Awake() {
	...
	std::filesystem::path defaultPath=
		(std::filesystem::path(BooEditor::editorPath) / "res/alpha/default.png")
		.generic_string();
	...
	std::filesystem::path logoPath =
		(std::filesystem::path(BooEditor::editorPath) / "res/alpha/logo.png")
		.generic_string();
...
void EditorLoading::_initLoadUI() {
	...
	this->_spriteLoadBar =
		dynamic_cast<UISprite*>(this->_ndLoadBar->addComponent("UISprite"));
...
void EditorLoading::_initAssetsDB() {
	// BooEditor::cache->initAssetsDBMaps(&EditorLoading::_initAssetsDBCallback,
	// this);
}
