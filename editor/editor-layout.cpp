...
void EditorLayout::_initMainUI()
{
   ...
   /* this->_spriteMain = this->_ndMain->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initMenuUI()
{
   ...
   /* this->_spriteMenu = this->_ndMenu->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initHierarchyUI()
{
    ...
    /*this->_spriteHierarchy = this->_ndHierarchy->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initAssetsUI()
{
    ...
    /*this->_spriteAsset = this->_ndAsset->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initSceneUI()
{
   ...
   /* this->_spriteScene = this->_ndScene->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initToolUI()
{
    ...
    /*this->_spriteTool = this->_ndTool->addComponent<Sprite>("Sprite");
...
void EditorLayout::_initPropertyUI()
{
   ...
   /* this->_spriteProperty = this->_ndProperty->addComponent<Sprite>("Sprite");
