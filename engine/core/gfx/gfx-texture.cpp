...
bool GfxTexture::saveToFile(const std::string& filePath, uint32_t width, uint32_t height)
{
    ...
    /* // 6. 映射内存并读取数据 */
    void* data;
    vkMapMemory(this->_context->getVkDevice(), stagingBufferMemory, 0, imageSize, 0, &data);
