...
void GfxDescriptor::_createDescriptorPool()
{
    ...
    poolSizes[0].descriptorCount = swapChainImageCount * this->_maxObjectCount * this->_samplerCount; // 单个描述符集3

    VkDescriptorPoolCreateInfo poolInfo{};
    poolInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    poolInfo.poolSizeCount = static_cast<uint32_t>(poolSizes.size());
    poolInfo.pPoolSizes = poolSizes.data();
    poolInfo.maxSets = swapChainImageCount * this->_maxObjectCount; // 描述符集的最大数量
