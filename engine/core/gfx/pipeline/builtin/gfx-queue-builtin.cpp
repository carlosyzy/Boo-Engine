...
GfxQueueBuiltin::GfxQueueBuiltin(GfxRendererBuiltin *renderer)
{
...
void GfxQueueBuiltin::_beginCommandBuffer(uint32_t imageIndex)
{
...
void GfxQueueBuiltin::_beginRenderPass(uint32_t imageIndex)
{
