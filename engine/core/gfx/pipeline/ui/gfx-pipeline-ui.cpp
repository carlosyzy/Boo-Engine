...
void GfxPipelineUI::_initDynamicState()
{
    this->_dynamicStates = {
...
void GfxPipelineUI::_initViewportState()
{
    this->_viewport = {};
...
void GfxPipelineUI::_initRasterizationState()
{
    GfxPipeline::_initRasterizationState();
}

void GfxPipelineUI::_initMultisampleState()
{
...
void GfxPipelineUI::_initDepthStencilState()
{
    GfxPipeline::_initDepthStencilState();
}
void GfxPipelineUI::_initColorBlendState()
{
...
void GfxPipelineUI::_initPipelineLayout()
{
...
void GfxPipelineUI::_initPipeline()
{
