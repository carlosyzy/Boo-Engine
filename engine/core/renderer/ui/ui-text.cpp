...
void UIText::setText(std::string text)
{
    ...
    this->_texture = new TextureAsset(this->_fontTexture.uuid, this->_fontTexture.width, this->_fontTexture.height, this->_fontTexture.channels, this->_fontTexture.datas);
...
void UIText::_updateRendererState()
{
 ...
 * 更新模型矩阵
 */
void UIText::_updateModelMatrix()
{
